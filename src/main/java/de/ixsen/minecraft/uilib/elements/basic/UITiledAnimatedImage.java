 ...
 * @author Subaro
 */
public class UITiledAnimatedImage extends UIAnimatedImage {

    public UITiledAnimatedImage(UIAnimatedImageData imageData, int tickSpeed) {
        super(imageData, tickSpeed);
    }

    public UITiledAnimatedImage(UIContainer parentContainer, UIAnimatedImageData imageData, int tickSpeed) {
                ...
                for (int cY = 0; cY < size.getHeight(); cY += this.imageData
                    ...
                    for (int cX = 0; cX < size.getWidth(); cX += this.imageData
                        ...
                        if (remainingWidth >= this.imageData.getuWidth()
                            ...
                            // Draw a fully image
                            this.drawImage(currentImage, myGlobalPos.getX() + cX,
                            ...
                            this.drawSnippedImage(currentImage, myGlobalPos.getX() + cX,
