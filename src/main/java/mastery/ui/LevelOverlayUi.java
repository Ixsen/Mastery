...
public class LevelOverlayUi extends Gui implements IMasteryEventListener {
    ...
    private void drawOverlay(Minecraft mc, IMastery mastery, MASTERY_SPEC activeMastery) {
        ...
        drawModalRectWithCustomSizedTexture(xOffset, yOffset, 0, 0, this.ICON_SIZE, this.ICON_SIZE, this.ICON_SIZE, this.ICON_SIZE);
        GL11.glPopMatrix();
        ...
        this.drawTexturedModalRect(MasteryConfiguration.UI_OVERLAY.uiOffsetX,
                MasteryConfiguration.UI_OVERLAY.uiOffsetY + (this.ICON_SCALE * this.ICON_SIZE), 0, 0, this.BACK_WIDTH, this.BACK_HEIGHT);
        ...
        this.drawTexturedModalRect(MasteryConfiguration.UI_OVERLAY.uiOffsetX + 1,
                MasteryConfiguration.UI_OVERLAY.uiOffsetY + (this.ICON_SCALE * this.ICON_SIZE) + 1, 1, this.BACK_HEIGHT + 1,
                currentBarWidth, this.BAR_HEIGHT);
        GL11.glPopMatrix();
